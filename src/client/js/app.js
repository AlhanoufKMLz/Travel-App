...
// GET the destination country from the user
...
const updateModal = (trip) => {
    ...
    const daysLeft = calcDuration(new Date(), tripStart);
    document.querySelector('.trip_duration').innerHTML = `Your trip to ${trip.destination} is ${daysLeft} days away.`;
    
    // Display weather info
    showWeather(trip, daysLeft, tripStart);
}

//
const showWeather = (trip, daysLeft, tripStart) => {
...
const displaySavedTrip = (trip) => {
    ...
    div.innerHTML = `<div class="modal-body left-side">
                    ...
                    <div class="modal-body right-side">
                        ...
                        <span class="trip_duration">Your trip to ${trip.destination} is ${daysLeft} days away.</span>
                    </div>`;
...
export { getDestination, getStartingDate, getReturnDate, calcDuration, updateModal, displaySavedTrip };